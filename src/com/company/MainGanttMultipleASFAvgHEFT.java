...
public class MainGanttMultipleASFAvgHEFT extends JFrame {
    ...
    public MainGanttMultipleASFAvgHEFT(String title, Schedule schedule) {
        super(title);
...
//            Schedule tmpSchedule = Heuristics.DynamicASFHEFTAdjacentMax(schedule, taskDAG);
        ...
        SwingUtilities.invokeLater(() -> {
            MainGanttMultipleASFAvgHEFT example = new MainGanttMultipleASFAvgHEFT("Gantt Chart", schedule);
