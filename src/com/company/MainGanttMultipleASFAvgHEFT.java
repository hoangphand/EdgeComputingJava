...
public class MainGanttMultipleASFAvgHEFT extends JFrame {

    private static final long serialVersionUID = 1L;

    public MainGanttMultipleASFAvgHEFT(String title, String chartLabel, Schedule schedule) {
        super(title);
...
//            Schedule tmpSchedule = Heuristics.DynamicASFHEFTAdjacentMax(schedule, taskDAG);
        ...
        SwingUtilities.invokeLater(() -> {
            MainGanttMultipleASFAvgHEFT example = new MainGanttMultipleASFAvgHEFT(
                    "ASFAvgHEFT",
                    "ASFAvgHEFT (Accepted: " + GR + ", Cloud cost: " + cloudCost + ")",
                    schedule);
